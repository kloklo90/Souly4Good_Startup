...
class ProgressesControllerTest < ActionController::TestCase
  ...
  test "should create progress" do
    assert_difference('Progress.count') do
      post :create, progress: { current_value: @progress.current_value, level_key: @progress.level_key, users_id: @progress.users_id }
    end
  ...
  test "should update progress" do
    patch :update, id: @progress, progress: { current_value: @progress.current_value, level_key: @progress.level_key, users_id: @progress.users_id }
    assert_redirected_to progress_path(assigns(:progress))
  end
